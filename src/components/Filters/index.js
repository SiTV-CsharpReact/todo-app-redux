...
export default function Filters() {
  ...
  const handPriorityChange = (value) =>{
  ...
  return (
    <Row justify='center'>
      <Col span={24}>
        ...
        <Search placeholder='input search text' onChange={handSearchTextChange} />
      </Col>
      <Col sm={24}>
        <Typography.Paragraph
          style={{ fontWeight: 'bold', marginBottom: 3, marginTop: 10 }}
        ...
        <Radio.Group value={filterStatus} onChange={handStatusChange}>
